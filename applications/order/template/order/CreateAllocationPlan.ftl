...
<form class="basic-form" method="post" name="CreateAllocationPlan" id="CreateAllocationPlan" action="<@ofbizUrl>CreateAllocationPlan</@ofbizUrl>">
  <div id="findOrders" class="screenlet">
    <div class="screenlet-title-bar">
      <ul>
        <li class="h3">${uiLabelMap.PageTitleCreateAllocationPlan}</li>
      </ul>
      <br class="clear"/>
    </div>
